...
//    val events = listOf<S3EventNotificationRecord>(S3EventNotificationRecord(
//        "us-west-2",
//        "ObjectCreated:Put",
//        "aws:s3",
//        null,
//        "2.1",
//        RequestParametersEntity("23.241.230.109"),
//        null,
//        S3Entity(
//            "transcoding-dev-MetadataGeneration-dcc0201c9649d770169a0b13f261d68f",
//            S3BucketEntity(
//                "manifest-output",
//                UserIdentityEntity("ARAKUEIRWNFD6"),
...
//            "1.0"
//        ),
//        UserIdentityEntity("AWS:AIDAIOIDTOV3ONC5FFFEU")
//    ))

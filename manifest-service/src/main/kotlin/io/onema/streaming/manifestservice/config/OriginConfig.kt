...
package io.onema.streaming.manifestservice.config

import com.amazonaws.services.s3.AmazonS3ClientBuilder
import io.onema.streaming.manifestservice.service.FileService
import io.onema.streaming.manifestservice.service.LocalFileService
import io.onema.streaming.manifestservice.service.S3FileService
...
class OriginConfig {
    ...
    @Bean
    fun fileSytemManager(): FileSystemManager = VFS.getManager()
